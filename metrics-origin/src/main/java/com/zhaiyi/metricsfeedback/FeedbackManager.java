...
import com.zhaiyi.metricsfeedback.lifecycle.LifeCycleSupport;
import com.zhaiyi.metricsfeedback.util.LogUtil;
...
public class FeedbackManager extends LifeCycleSupport {
    ...
    public FeedbackManager(int poolSize) {
        this(MetricRegistryUtil.getMetricRegistry(), poolSize);
    }
    ...
    public FeedbackManager(MetricRegistry registry, int poolSize) {
        ...
        MetricRegistryUtil.setMetricRegistry(registry);
    }
    ...
    public void addConfiguration(FeedbackConfiguration fc) {
        feedbackExecutorService.addConfiguration(fc);
    }
